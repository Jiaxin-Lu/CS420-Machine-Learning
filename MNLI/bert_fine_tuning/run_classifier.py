...
class SmallNLIProcessor(DataProcessor):
    """Processor for the MultiNli data set"""
    ...
    def get_train_examples(self, data_dir):
        lines = self._read_csv(data_dir, "trainData_small.csv")
    ...
    def get_dev_examples(self, data_dir):
        lines = self._read_csv(data_dir, "devData_small.csv")
...
def main(_):
  ...
  processors = {
      ...
      "mrpc": MrpcProcessor,
      "xnli": XnliProcessor,
      "muln": MultiNLIProcessor,
      "smnli": SmallNLIProcessor,
  }
